...
The dataset was downloaded from [Kaggle](https://www.kaggle.com/datasets/adilshamim8/social-media-addiction-vs-relationships) and saved to a local directory. It was then imported into R as `df0` using the built-in `read.csv()` function with a relative file path. The structure of `df0` was shown in [Output 1](#str-df) below.
...
[*Output 1: Structure of the Dataframe*]{.caption}
:::
