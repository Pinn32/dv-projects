...
![Sankey diagram of average tourist visa costs from each area (sorted)](./img/fig2-sankey-sorted.png){#fig-sankey-sorted fig-alt="Sankey diagram of average tourist visa costs from each area (sorted)"}
...
# Appendix: Dataset Information {#appendix}
