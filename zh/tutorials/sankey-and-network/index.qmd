...
description: '本章介绍桑基图与网络图的绘制方法，包括数据准备、图表创建和样式调整等。'
order: 4
---
...
![网络图 html 输出结果演示（gif 动图）](../../../src/img/ttl/sankey/fig7-network-sample.gif){#fig-network-sample}
...
![修改后的网络图](../../../src/img/ttl/sankey/fig8-network-sample-modified.png){#fig-network-sample-modified}
