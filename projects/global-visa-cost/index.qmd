...
Pandas (2024c) *pandas.DataFrame.reset_index*. Available at: [pandas](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.reset_index.html) (Accessed: 11 December 2024) Pandas (2024d) *pandas.DataFrame.sort_values*. Available at: [pandas](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.sort_values.html#pandas.DataFrame.sort_values) (Accessed: 12 December 2024)
